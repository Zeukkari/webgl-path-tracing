...
export default class Line {
  ...
  intersectionWith(obj) {
    ...
    var k =
      (XdotQsubP * YdotY / XdotX + XdotY * YdotPsubQ) / (YdotY - XdotY * XdotY);
  ...
  pointClosestTo(obj) {
    if (obj.direction) {
      ...
      var x = D3 * E1 - D1 * E3,
        y = D1 * E2 - D2 * E1,
        z = D2 * E3 - D3 * E2;
      var N = new Vector([x * E3 - y * E2, y * E1 - z * E3, z * E2 - x * E1]);
  ...
  static get X() {
    return new Line(Vector.Zero(3), Vector.i);
  }

  static get Y() {
    return new Line(Vector.Zero(3), Vector.j);
  }

  static get Z() {
    return new Line(Vector.Zero(3), Vector.k);
  }
}
